    ...
    <footer className="w-full text-gray-400 bg-gray-900 body-font pb-8 mt-16">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">
          © 2023 All Right Reserved SadaBahar —
          <a
        ...
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start md:mr-4">
          <Link
            to={
              // "https://www.facebook.com/profile.php?id=100052821680235&mibextid=ZbWKwL"
              "https://www.facebook.com/profile.php?id=100082449565879&mibextid=ZbWKwL"
            }
            target="_blank"
          ...
          {/* <Link
            to={"https://instagram.com/yes_itx_imran"}
            target="_blank"
          ...
          <Link
            to={"https://github.com/Muhammadimran7808"}
            target="_blank"
            className="ml-3 text-gray-400 hover:text-white"
          >
            <FaGithub size={25} />
          ...
          <Link
            to={
              "https://www.linkedin.com/in/azmat-fareed-digital-marketer?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
            }
            target="_blank"
            className="ml-3 text-gray-400 hover:text-white"
          >
